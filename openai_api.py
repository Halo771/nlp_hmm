...
if __name__ == "__main__":
    ...
    #model = AutoModel.from_pretrained(MODEL_PATH, trust_remote_code=True).quantize(4).cuda().eval()
    tokenizer = AutoTokenizer.from_pretrained("D:\model_glm3", trust_remote_code=True,)
    model = AutoModel.from_pretrained("D:\model_glm3", trust_remote_code=True).quantize(bits=4, device="cuda").cuda().eval()
